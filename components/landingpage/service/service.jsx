    ...
    >
      <div className="w-full flex md:flex-row flex-col justify-between">
        ...
        <div className="flex gap-6 md:w-2/3 w-full">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="text-xs my-4 text-center md:text-left">
      ...
      <div className="w-full pt-8 flex md:flex-row flex-col items-center">
        ...
        >
          ...
          <button
            className="text-xs md:text-lg md:px-8 md:py-6 py-3 px-4 rounded-3xl text-white mb-8"
        ...
        <div
          className="grid md:grid-cols-2 grid-cols-1 font-normal gap-6 place-items-center"
          data-aos="zoom-in-left"
          data-aos-duration="2000"
        >
          <div
            className="max-w-md max-h-96 flex flex-col justify-between rounded-3xl px-5 py-4"
          ...
          >
            ...
            <p className="md:text-sm text-xs">
              ...
              with practical real-life projects that help you build a compelling
              portfolio.
            </p>
          </div>
          ...
          >
            ...
            <p className="md:text-sm text-xs">
              ...
              advertisements, recommendations, and frequently asked questions to
              ensure you are prepared for any opportunity.
            </p>
          </div>
