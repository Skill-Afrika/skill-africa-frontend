...
const Freelancer = () => {
  ...
  return (
    <div
      className="md:px-16 px-8 md:pt-32 pt-12"
      data-aos="zoom-in-up"
    ...
    >
      ...
      <div className="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-8 place-items-center">
        <div className="flex flex-col w-full md:h-60 h-48 bg-white md:px-6 px-3 py-3 md:py-6 rounded-2xl border border-solid border-red-200">
        ...
        <div className="flex flex-col w-full md:h-60 h-48 bg-white md:px-6 px-3 py-3 md:py-6 rounded-2xl border border-solid border-red-200">
          ...
          <p className="md:text-sm text-xs">
            The coupons and courses shared on SkillAfrika have ensured a
            considerable advance in my education. I now have many certificates
            to my name that make me highly sought after when I apply to any
            organization.
          </p>
        </div>
        ...
        <div className="flex flex-col w-full md:h-60 h-48 bg-white md:px-6 px-3 py-3 md:py-6 rounded-2xl border border-solid border-red-200">
          ...
          <p className="md:text-sm text-xs">
            ...
            gain knowledge in Tech Skills, especially in Data Analytics by
            providing free Udemy Coupons, LinkedIn learning access, and
            encouraging me to fight against procrastination.
          </p>
        </div>
        ...
        <div className="flex flex-col w-full md:h-60 h-48 bg-white md:px-6 px-3 py-3 md:py-6 rounded-2xl border border-solid border-red-200">
          ...
          <p className="md:text-sm text-xs">
            ...
            space. Aside from providing me with so many free courses to help me
        ...
        <div className="flex flex-col w-full md:h-60 h-48 bg-white md:px-6 px-3 py-3 md:py-6 rounded-2xl border border-solid border-red-200">
          ...
          <p className="md:text-sm text-xs">
            The most important thing for me is beating procrastination. I have
            taken my online classes seriously and also have free Udemy courses I
            did not spend a dime on. Thank you, Skill Afrika.
          </p>
        </div>
        ...
        <div className="flex flex-col w-full md:h-60 h-48 bg-white md:px-6 px-3 py-3 md:py-6 rounded-2xl border border-solid border-red-200">
          <div className="flex items-center mb-3">
            <Image src={img1} alt="img" className="mr-4" />
            <div className="flex flex-col">
              <h1 className="text-sm font-semibold">Abdullahi Uche</h1>
              <h2 className="text-xs">Developer</h2>
            </div>
          </div>
          <p className="md:text-sm text-xs">
            Since I joined Skill Afrika, I have learned to balance my time
            effectively, and gained new skills that helped me elevate my work
            and get more visibility on LinkedIn. It has been a game-changer for
