    ...
    <div className='px-16 flex flex-col justify-between'>
      <div className='w-full flex md:flex-row flex-col md:justify-between justify-center'>
        ...
        <div className='flex gap-6 md:w-2/3 w-full'>
          <Image src={img1} className='md:block hidden' alt='' />
          <div className='flex flex-col'>
            <h1 className='md:text-3xl font-semibold text-sm'>
      ...
      <div className='w-full pt-8 flex md:flex-row flex-col items-center'>
        <div className='flex flex-col md:items-start items-center'>
          <h1 className='md:text-3xl font-semibold text-xs mb-4'>
            We provides the range of services.
          </h1>
          <button
            className='text-xs md:text-lg md:px-8 md:py-4 px-3 py-2 rounded-3xl text-white'
        ...
        <div className='grid md:grid-cols-2 grid-cols-1 place-content-between md:ml-6 mr-0 font-normal'>
          <div
            className='max-w-md h-80 flex flex-col gap-6 rounded-3xl px-8 py-8 md:mr-6 mr-0 my-8'
            style={{ backgroundColor: "rgba(252, 239, 230, 0.8)" }}>
            <Image src={img2} alt='img' />
            <h1 className='md:text-2xl text-xs'>Skill Training</h1>
            <p className='md:text-sm text-xs'>
              Lorem ipsum dolor sit amet consectetur. Penatibus id suscipit non
              ullamcorper diam. Iaculis porttitor nunc nisi cras.
            </p>
          </div>
          <div
            className='max-w-md h-80 flex flex-col gap-6 rounded-3xl px-8 py-8 md:mr-6 mr-0 my-8'
